...
public:
    ...
    void write(FileStorage& fs) const  // Write serialization for this class
    {
        fs << "{"
           ...
           << "Write_gridPoints" << writeGrid << "Write_outputFileName"
           << outputFileName
...
int main(int argc, char* argv[])
{
    const String keys =
        ...
        "{@settings      |/home/davi/project/camera_calibration/in_VID5.xml| "
        "input setting file            }"
                           ...
                           bool release_object)
{
    ...
    else
    {
        ...
        rms = calibrateCameraRO(objectPoints, imagePoints, imageSize,
                                iFixedPoint, cameraMatrix, distCoeffs, rvecs,
    ...
    if (release_object)
    {
        ...
        cout << newObjPoints[s.boardSize.width * (s.boardSize.height - 1)]
             << endl;
