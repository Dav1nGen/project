...
bool Detector::JudgeLinePatrol()
{
         ...
         contour_1++)
    {
             ...
             contour_2++)
        {
            ...
            {
                cv::Point2f
                    rect_points_1[4];  // point[0]左下:x最小 point[1]左上:y最小
                                       // point[2]右上:x最大 point[3]右下:y最大
                ...
                cv::Point2f
                    rect_points_2[4];  // point[0]左下:x最小 point[1]左上:y最小
                                       // point[2]右上:x最大 point[3]右下:y最大
                ...
                this->targrt_point = cv::Point2f(
                    (rect_1_center_point.x + rect_2_center_point.x) / 2,
                    (rect_1_center_point.y + rect_2_center_point.y) / 2);
                cv::circle(black_img, this->targrt_point, 3,
                           cv::Scalar(255, 255, 255), 1, 8, 0);
                cv::circle(black_img, this->car_direction, 1,
                           cv::Scalar(255, 255, 255), 1, 8, 0);
                debug_img = black_img.clone();
                return true;
            }
